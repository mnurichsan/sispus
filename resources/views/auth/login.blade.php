...
<head>
    ...
    <title>Login Page - Sistem Informasi Pusksesmas Tanrutedong Sidrap</title>
                                        ...
                                        <div class="card-content">
                                            <div class="card-body pt-1">
                                                ...
                                                <form action="{{route('login')}}" method="POST">
                                                    ...
                                                    <button type="submit" class="btn btn-primary float-right btn-inline mb-3">Login</button>
                                                </form>
                                            </div>
                                        </div>
